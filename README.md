...
**I00：产品契约冻结**、**I01：可运行的空 CLI** 和 **I02：统一清单 Schema 与 fixture 框架** 已于 2026-07-15 通过维护者验收。I03 尚未开始；扫描、配置和其他产品能力也尚未开始。
...
I02 的公开清单契约位于 [`schemas/inventory/v0.1.0.json`](./schemas/inventory/v0.1.0.json)，手工示例位于 [`examples/inventory-report.json`](./examples/inventory-report.json)。Schema 会嵌入核心并在本地校验，校验过程不需要联网。
