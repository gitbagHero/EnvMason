...
**I00：产品契约冻结**、**I01：可运行的空 CLI**、**I02：统一清单 Schema 与 fixture 框架**、**I03：macOS 系统只读探测**、**I04：通用可执行文件发现器**、**I05：Homebrew 只读适配器** 和 **I06：Node.js 生态只读适配器** 已通过验收。I07 尚未开始；Java 生态、统一报告、配置和系统修改能力也尚未开始。
